...
The current project will conduct an analysis of the e-commerce data through Python, SQL, and Power BI. The project will use SQL queries to make an in-depth analysis and will create a Power BI dashboard that can provide valuable insights about the customer behavior, sales trend, and product performance. The idea of the project was taken from the dataset of Target, available on Kaggle.
...
![Dashboard Overview](https://github.com/Chalseyji/Ecommerce-analysis-shaunak/blob/main/Dashboard/dashboard_overview.png)
![Dashboard Details](https://github.com/Chalseyji/Ecommerce-analysis-shaunak/blob/main/Dashboard/dashboard_details.png)
